 ...
 */
export declare class CfnMatchingWorkflow extends cdk.CfnResource implements cdk.IInspectable {
    /**
 ...
 */
export declare class CfnSchemaMapping extends cdk.CfnResource implements cdk.IInspectable {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
